...
static_assert(
    std::is_same_v<decltype(S::f1), decltype(SoRVec::f1)::value_type>);
static_assert(
    std::is_same_v<decltype(S::f2), decltype(SoRVec::f2)::value_type>);
static_assert(
    std::is_same_v<decltype(S::f3), decltype(SoRVec::f3)::value_type>);
static_assert(
    std::is_same_v<decltype(S::f4), decltype(SoRVec::f4)::value_type>);
static_assert(
    std::is_same_v<decltype(S::f5), decltype(SoRVec::f5)::value_type>);
